...
const emit = defineEmits(["dragged", "update-element"]);

const handleDrag = (event) => {
  if (
    props.element.data.draggable == true ||
    typeof props.element.data.draggable == "undefined"
  )
    emit("dragged", event);
};
</script>